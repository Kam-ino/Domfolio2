const difficultyColors = {
  'SS+': { border: '#d4af37', glow: 'rgba(212, 175, 55, 0.22)' },
  SS: { border: '#9b3d3d', glow: 'rgba(155, 61, 61, 0.18)' },
  S: { border: '#c9962f', glow: 'rgba(201, 150, 47, 0.18)' },
  A: { border: '#4c6c47', glow: 'rgba(76, 108, 71, 0.18)' },
